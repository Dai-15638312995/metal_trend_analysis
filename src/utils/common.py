...
class StooqClient:
    ...
    def _save_debug_response(self, symbol: str, text: str) -> Optional[Path]:
        """保存调试响应内容，便于在 GitHub Actions Artifact 中查看。"""
        try:
    ...
    def _parse_csv_response(self, symbol: str, text: str) -> pd.DataFrame:
        ...
        if "<html" in lowered or "<!doctype html" in lowered:
            ...
            raise DataFetchError(
                ...
                f"Possible anti-bot page / temporary site issue."
            )
        ...
        if header_index is None:
            ...
            raise DataFetchError(
                ...
                f"Expected header like Date,Open,High,Low,Close"
            )
    ...
    def _request_csv(self, symbol: str) -> pd.DataFrame:
        ...
        try:
            self.logger.debug(f"Requesting data for symbol: {symbol} with params: {params}")
